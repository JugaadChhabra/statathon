...
async function analyzeText(input_text) {
    ...
    try {
        ...
        console.log('Making API request to:', "".concat(API_BASE_URL, "/analyze/"));
...
async function getAnalyses() {
    try {
        const response = await fetch("".concat(API_BASE_URL, "/analyses/"), {
            method: "GET",
            headers: {
                "Accept": "application/json"
            }
...
//# sourceMappingURL=app_58843627._.js.map