...
;
;
// Real Canadian survey datasets
const AVAILABLE_SURVEYS = [
    {
        name: "Canadian Community Health Survey (CCHS)",
        year: 2024,
        description: "Annual survey collecting health information on Canadians",
        totalResponses: 130000,
        datasetSize: "2.1 GB",
    ...
    },
    {
        ...
        year: 2024,
        description: "Monthly survey of labour market conditions",
        totalResponses: 56000,
        datasetSize: "850 MB",
    ...
    },
    {
        ...
        year: 2023,
        description: "Social trends and well-being of Canadians",
    ...
    {
        name: "Youth Smoking Survey (YSS)",
        year: 2023,
        description: "Tobacco and substance use among Canadian youth",
        totalResponses: 42000,
        datasetSize: "320 MB",
    ...
    {
        name: "National Household Survey (NHS)",
        year: 2021,
        description: "Detailed socioeconomic information about households",
        totalResponses: 4500000,
        datasetSize: "8.2 GB",
...
// Analysis type options with descriptions
const ANALYSIS_TYPES = [
    ...
    },
    {
        ...
        description: 'Compare across demographics/regions'
    },
    {
        value: 'statistical',
...
_s(AnalysisParametersForm, "yQKkpvTxMvZZI96SVc8kmwgTiFw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$context$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
_c2 = AnalysisParametersForm;
...
__turbopack_context__.k.register(_c2, "AnalysisParametersForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const SurveyExplorerApp = ()=>{
    ...
    const handleAnalyze = async (formData)=>{
        ...
        setValidationErrors({});
        try {
            var _backendResult_explanation_json;
            ...
            const analysisResult = {
                ...
                latency: backendResult.latency_ms,
                timestamp: new Date(backendResult.created_at).toLocaleString(),
                version: '1.0.0'
            };
...
//# sourceMappingURL=app_9fb4b6bb._.js.map